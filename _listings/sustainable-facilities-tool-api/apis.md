...
- name: Sustainable Facilities Tool API Workspaces
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/workspaces/master/_listings/sustainable-facilities-tool-api/workspaces-parameter-material-groups-get-postman.md
x-common:
- type: x-developer
