...
- name: Sustainable Facilities Tool API Workspace
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/workspaces/master/_listings/sustainable-facilities-tool-api/workspaces-parameter-get-postman.md
x-common:
- type: x-developer
